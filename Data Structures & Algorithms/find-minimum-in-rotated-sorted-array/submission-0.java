class Solution {
    public int findMin(int[] nums) {
        ...
        while (lowerBound <= upperBound){
            ...
            if (nums[lowerBound] <= nums[upperBound]){//lower and upper bound are along the same sequence of numbers, the lower bound should be the minimum if not the current result
